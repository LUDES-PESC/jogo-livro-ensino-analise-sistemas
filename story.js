...
squiffy.story.sections = {
	...
	'Porta de Entrada': {
		...
		'passages': {
			...
			'Você toca a campainha': {
				'text': "<p><img src=\"debora.png\" width=200/></p>\n<p>A campainha toca uma música conhecida, mas você não sabe qual. \nDepois de uns quinze segundos uma moça de uns 25 anos, com um sorriso simpático e uniforme profissional, abre a porta e pergunta:</p>\n<ul>\n<li>Em que posso ajudar?</li>\n</ul>\n<p><a class=\"squiffy-link link-section\" data-section=\"Recepcao\" role=\"link\" tabindex=\"0\">Você explica que é o analista de sistemas que veio começar o serviço do novo sistema</a>.</p>",
			},
		},
	},
	'Porta2': {
	...
	'Recepcao': {
		...
		'passages': {
			...
			'Você senta no sofá': {
				'text': "<p>Depois de cinco minutos, Débora pede para você seguir pela porta menor, que leva a um <a class=\"squiffy-link link-section\" data-section=\"corredor\" role=\"link\" tabindex=\"0\">corredor</a>, e ir para a última porta desse <a class=\"squiffy-link link-section\" data-section=\"corredor\" role=\"link\" tabindex=\"0\">corredor</a>, que tem uma placa onde diz &quot;sala de reuniões&quot;. Ela ainda diz: &quot;Quando estiver pronto para sair, volte a recepção, é o único caminho&quot;.</p>",
			},
		},
	},
	'corredor': {
	...
	'sala da gerência': {
		...
		'passages': {
			...
			'antigas': {
				'text': "<p>Bruna diz:</p>\n<ul>\n<li>Fazemos as coisas do mesmo jeito aqui há muitos anos. Com a carga de trabalho aumentando, concordo que um sistema de vendas pode ajudar, mas não acho que precisamos mudar tanto.</li>\n</ul>\n<p>E Armando comenta:</p>\n<ul>\n<li><p>A livraria funciona da mesma forma há muitos anos, com tudo feito de forma manual. Porém, com a possibilidade cada vez maior de trabalhar com livros do mundo todo, nosso trabalho aumentou muito. Meu pai é “das antigas”, mas eu o convenci a começar a mudar as coisas, para eu poder tocar melhor o negócio com a Bruna quando papai se aposentar. \nBruna parece ter problemas com essa opinião:</p>\n</li>\n<li><p>Melhor não mexer muito, estamos crescendo e em time que está ganhando não se mexe. É só resovler uns probleminhas aqui e ali.</p>\n</li>\n</ul>\n<p>Armando chama a atenção para si:</p>\n<ul>\n<li><p>O importante é que o sistema atenda bem a vontade do cliente: encomendar um livro raro, que não é encontrado com facilidade, e que cabe a gente procurar e dar um preço. \nVocê pode perguntar:</p>\n</li>\n<li><p><a class=\"squiffy-link link-passage\" data-passage=\"sistemas\" role=\"link\" tabindex=\"0\">Quais</a> outros sistemas vocês estão fazendo?</p>\n</li>\n</ul>",
			},
			'sistemas': {
				'text': "<p>Bruna olha para umas anotações que parece ter feito antes e fala:</p>\n<ul>\n<li>O importante é que se leve em conta que estamos comprando outros sistemas de informação não específicos para a Livraria ABC no mercado. Por exemplo, já temos um sistema de contas a pagar e a receber sendo implantado que deverá receber as informações do sistema que vocês vão fazer. \nIsso é realmente melhor que meus cadernos, pois não preciso fazer mais as contas.</li>\n</ul>\n<p>Ela olha para <a class=\"squiffy-link link-passage\" data-passage=\"necessidades\" role=\"link\" tabindex=\"0\">Armando</a>.</p>",
			},
			'necessidades': {
				'text': "<p>Armando pensa e diz:</p>\n<ul>\n<li>O que eu mais preciso é melhorar o nosso relacionamento com o cliente. Para isso, a informação que vem do sistema de vendas é essencial. \nUma coisa importante, por exemplo, é saber que clientes freqüentes não compram mais na freqüência que compravam. Sabendo isso eu posso recuperar um cliente que deixou de nos procurar.</li>\n</ul>\n<p>Você pergunta se eles tem <a class=\"squiffy-link link-passage\" data-passage=\"oportunidade 1\" role=\"link\" tabindex=\"0\">alguma idéia</a>,</p>",
			},
			'oportunidade 1': {
	...
	'sala dos vendedores': {
		'text': "<h1 id=\"sala-dos-vendedores\">Sala dos vendedores</h1>\n<p><img src=\"vendedores.png\" width=400></p>\n<p>Você encontra duas pessoas trabalhando no telefone, cada um em sua mesa. Certamente são Felipe Franciscano e Gabriela Gambra.</p>\n<p>Ambos estão parecendo bastante ocupados. Felipe está de terno, como o patrão. Gabriela também usa uma roupa mais formal. </p>\n<p>Você espera na porta <a class=\"squiffy-link link-section\" data-section=\"pacientemente\" role=\"link\" tabindex=\"0\">pacientemente</a> na porta ou tenta <a class=\"squiffy-link link-passage\" data-passage=\"interromper\" role=\"link\" tabindex=\"0\">interromper</a>?</p>",
		'attributes': ["salas+=1"],
		'passages': {
			'interromper': {
	...
	'como funciona o trabalho': {
		...
		'passages': {
			...
			'pagam': {
				'text': "<p>Gabriela não parece gostar desse assunto:</p>\n<ul>\n<li>Hoje pelo boleto, no Brasil, ou por depósito internacional. É muito ruim, porque demora uns 3 dias para sabermos que foi pago, e o cliente às vezes esquece de pagar e pede uma segunda via, ou ainda temos que lembrá-los disso, o que é sempre desagradável. Sem falar que, apesar dos clientes antigos estarem acostumados, os novos sempre reclamam. Eles querem usar cartão de crédito, Pix no Brasil ou PayPal no exterior.</li>\n</ul>\n<p>Felipe diz:</p>\n<ul>\n<li>A gente também pensou em usar cartão de crédito ou débito, Pix e outros serviços de pagamento, só não temos como fazer hoje. No passado a gente chegou a passar o cartão de crédito &quot;na mão&quot;, mas hoje não é mais possível.  </li>\n</ul>\n<p>Gabriela revira os olhos, como se essa discussão fosse antiga:</p>\n<ul>\n<li>A gente está muito atrasado. A desculpa eram as taxas, mas quem paga por transferência internacional paga as taxas e considera um custo adicional, sempre reclamam. É falta de sistema mesmo. Temos que resolver o pagamento urgente.</li>\n</ul>\n<p>Felipe diz:</p>\n<ul>\n<li>Lembro que nós temos que fazer o cliente pagar antes de nós pagarmos o fornecedor. A gente só envia o livro após o cliente pagar. Mas com cartão de crédito sempre a o risco de um caloteiro cancelar. Por isso preferimos pagamentos diretos, como o boleto e o Pix.</li>\n</ul>",
			},
			'@last': {
