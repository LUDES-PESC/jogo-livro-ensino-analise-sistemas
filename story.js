...
squiffy.story.sections = {
	...
	'pergunta': {
		...
		'passages': {
			'começar': {
				'text': "<p>{if not começou:\nVocê explica:</p>\n<ul>\n<li>Bem, eu tenho algumas perguntas para o senhor e para todos na empresa. \n}</li>\n</ul>\n<p>Você decide, sobre o que quer saber? </p>\n<ol>\n<li>Qual seu <a class=\"squiffy-link link-passage\" data-passage=\"problema\" role=\"link\" tabindex=\"0\">problema</a>?</li>\n<li>O que pode me falar sobre a <a class=\"squiffy-link link-passage\" data-passage=\"empresa\" role=\"link\" tabindex=\"0\">empresa</a>?</li>\n<li>Como os pedidos são <a class=\"squiffy-link link-passage\" data-passage=\"atendimento\" role=\"link\" tabindex=\"0\">atendidos</a>?</li>\n<li>Quem mais eu posso <a class=\"squiffy-link link-passage\" data-passage=\"entrevistar\" role=\"link\" tabindex=\"0\">entrevistar</a>?</li>\n</ol>",
			},
			'@last': {
			...
			'problema': {
				'text': "<p>Nossa empresa precisa mudar. Não dá para continuar como está. Tudo é muito atrasado. Meu filho acha que eu sou velho, mas eu sei que temos que ter atendimento via internet.</p>\n<p>Eu quero que você escute todos e faça um software que apoio o pessoal de vendas para vender por internet. Depois fazemos o resto.</p>\n<p>Mas lembre sempre que nós somos uma empresa com pouco estoque, negociamos com livros muito caros e quase sempre raros.</p>\n<p>Eu quero vender esses livros raros via internet.</p>\n<p>Creio que meu filho ficaria surpreso se me ouvisse falar!</p>\n<ol>\n<li>O que pode me falar sobre a <a class=\"squiffy-link link-passage\" data-passage=\"empresa\" role=\"link\" tabindex=\"0\">empresa</a>?</li>\n<li>Como os pedidos são <a class=\"squiffy-link link-passage\" data-passage=\"atendimento\" role=\"link\" tabindex=\"0\">atendidos</a>?</li>\n<li>Quem mais eu posso <a class=\"squiffy-link link-passage\" data-passage=\"entrevistar\" role=\"link\" tabindex=\"0\">entrevistar</a>?</li>\n</ol>",
				'attributes': ["começou"],
			},
			'empresa': {
				'text': "<p>O Sr. Arnaldo parece feliz em falar de sua empresa:</p>\n<ul>\n<li>Eu que fundei essa livraria, 40 anos atrás. A Livraria Resolve atua no mercado de venda de livros de arte e livros raros, de colecionadores, sob encomenda. </li>\n</ul>\n<p>Ele continua...</p>\n<ul>\n<li><p>Nossa atuação não prevê a manutenção de livros em estoque. Todos os livros solicitados por seus clientes são, semanalmente, encomendados às editoras, distribuidoras, outras livrarias e outros vendedores em geral. Nós somos uma espécie de empresa de corretagem, que facilita a vida de colecionadores.</p>\n</li>\n<li><p>Você quer saber mais como a livraria <a class=\"squiffy-link link-passage\" data-passage=\"funciona\" role=\"link\" tabindex=\"0\">funciona</a>?</p>\n</li>\n</ul>",
				'attributes': ["começou"],
			},
			'funciona': {
			...
			'clientes': {
				'text': "<p>O dono da empresa continua a falar, realmente sem dar chance para interrupções:</p>\n<ul>\n<li>Os clientes enviam seus pedidos pelo correio eletrônico, telefone ou fax, ainda temos um fax! O pedido é aceito se o cliente estiver previamente cadastrado. Caso contrário, o pedido é rejeitado com um aviso ao solicitante para se cadastrar. Isso é importante, pois nós normalmente pagamos os livros antes de receber por eles e são livros caros. Nas sextas-feiras, a livraria emite requisições de livros para os fornecedores, com base nos pedidos recebidos.\nQuando os livros são entregues pelo fornecedor, a livraria confere a nota de entrega da editora com a requisição, devolvendo as que contiverem erros.</li>\n</ul>\n<p>Você pode perguntar ainda:</p>\n<ol>\n<li>Qual seu <a class=\"squiffy-link link-passage\" data-passage=\"problema\" role=\"link\" tabindex=\"0\">problema</a>?</li>\n<li>Como os pedidos são <a class=\"squiffy-link link-passage\" data-passage=\"atendimento\" role=\"link\" tabindex=\"0\">atendidos</a>?</li>\n<li>Quem mais eu posso <a class=\"squiffy-link link-passage\" data-passage=\"entrevistar\" role=\"link\" tabindex=\"0\">entrevistar</a>?</li>\n</ol>",
			},
			'atendimento': {
				'text': "<p>O Sr. Arnaldo explica:</p>\n<ul>\n<li>Os pedidos dos clientes são atendidos imediatamente quando completos, isto é, quando todos os livros pedidos foram enviados pelos fornecedores (ou forem cancelados). O atendimento, que é a entrega pelo correio, consiste na emissão de uma nota fiscal, de um boleto de pagamento, que são enviados junto com o livro. Cópias da nota fiscal e do boleto são enviadas a tesouraria. </li>\n</ul>\n<p>Você então pergunta:</p>\n<ul>\n<li>Como um livro pode ser <a class=\"squiffy-link link-passage\" data-passage=\"cancelado\" role=\"link\" tabindex=\"0\">cancelado</a>?</li>\n</ul>",
				'attributes': ["começou"],
			},
			'cancelado': {
	...
	'sala de TI': {
		'text': "<h1 id=\"sala-de-ti\">Sala de TI</h1>\n<p>Você chega na Sala de TI e vê um homem agitado tentando colocar um computador em um rack, mas meio sem jeito. Ele pede sua ajuda com um olhar. Com certeza é o <strong>Carlos Castelo</strong>.</p>\n<p>Você <a class=\"squiffy-link link-passage\" data-passage=\"ajuda\" role=\"link\" tabindex=\"0\">ajuda</a>, levantando o rack um pouco para entrar na posição, ou você <a class=\"squiffy-link link-passage\" data-passage=\"finge\" role=\"link\" tabindex=\"0\">finge</a> que não.</p>",
		...
		'passages': {
			...
			'apresenta': {
				'text': "<p>Você se apresenta, diz que é responsável pela análise do novo sistema de informação da empresa, e precisa saber se há alguma demanda que ele pode <a class=\"squiffy-link link-passage\" data-passage=\"explicar\" role=\"link\" tabindex=\"0\">explicar</a>.</p>",
				'attributes': ["humor+=1"],
			},
			'quer': {
				'text': "<p>{if not seen apresenta: Você diz que quer algumas <a class=\"squiffy-link link-passage\" data-passage=\"explicar\" role=\"link\" tabindex=\"0\">explicações</a> e ele dá um suspiro\n}</p>",
				'attributes': ["humor-=1"],
			},
			'explicar': {
				'text': "<p>{if humor=2:Carlos Castelo está muito bem humorado}\n{if humor=1:Carlos Castelo está bem  humorado}\n{if humor=0:Carlos Castelo está com cara de cansado}\n{if humor=-1:Carlos Castelo está mal humorado}\n{if humor=-2:Carlos Castelo está muito mal humorado}</p>\n<ul>\n<li>Vamos lá, o que você quer saber - ele diz.</li>\n</ul>\n<p>Você explica que está interessado em <a class=\"squiffy-link link-passage\" data-passage=\"recomendacoes\" role=\"link\" tabindex=\"0\">como deve funcionar o sistema</a>, e quais são os softwares que deve usar.</p>",
			},
			'recomendacoes': {
				'text': "<p>Você deve se lembrar que essa empresa é antiga e tradicional.</p>\n<p>Tanto os donos e os funcionários, quanto muitos dos clientes, têm pouco hábito de usar computadores. O sistema deve ser muito simples de ser usado. Não pode ser confuso ou ter muitas opçoes para os clientes. Basicamente é só fazer e acompanhar pedido para eles.</p>\n<p>Outra coisa importante é que já instalamos um sistema gerenciador de banco de dados, o MySQL, por causa do sistema de ERP que instalamos. O sistema tem que usar esse SGDB.</p>\n<p>Tudo deve ser feito também para Web, porém em sites responsivos que funcionem em celulares. Por incrível que pareça, os mais velhos adotaram mais o celular que computadores. Não queremos nenhuma necessidade de instalar ou baixar algum software para o computador das pessoas.</p>\n<p>{if humor=2: Você pode escolher a linguagem de programação que for melhor para sua equipe}\n{if humor=1: Você pode escolher a linguagem de programação que for melhor para sua equipe, mas nada de PHP, por favor}\n{if humor=0: Antes de escolher uma linguagem de programação, eu devo aprovar}\n{if humor=-1: Você deve fazer tudo em PHP!}\n{if humor=-2: É essencial que o sistema seja todo em Perl.}</p>\n<p>Você pensa um pouco e pergunta se acha necessário <a class=\"squiffy-link link-passage\" data-passage=\"pagamento on-line\" role=\"link\" tabindex=\"0\">pagamento on-line</a>?</p>",
			},
			'pagamento on-line': {
				'text': "<p>Carlos pensa um pouco, não parece ser uma pergunta fácil. </p>\n<ul>\n<li>Não sei muito bem a tecnologia envolvida, mas sei que o ERP que compramos é compatível com esse serviço. Certamente nossos clientes iam gostar de pagar com cartão de crédito ou débito. Mas não sei se seria bom para a empresa, devido as taxas.</li>\n</ul>\n<p>Você acha que está tudo resolvido aqui e se <a class=\"squiffy-link link-passage\" data-passage=\"despede\" role=\"link\" tabindex=\"0\">despede</a>.</p>",
			},
			'despede': {
	...
	'sala da gerência': {
		...
		'passages': {
			...
			'sistemas': {
				'text': "<p>Bruna olha para umas anotações que parece ter feito antes e fala:</p>\n<ul>\n<li>O importante é que se leve em conta que estamos comprando outros sistemas de informação não específicos para a Livraria ABC no mercado. Por exemplo, teremos um sistema de contas a pagar e a receber que deverá receber as informações do sistema que vocês vão fazer. Isso é realmente melhor que meus cadernos, pois não preciso fazer mais as contas.</li>\n</ul>\n<p>Ela olha para <a class=\"squiffy-link link-passage\" data-passage=\"necessidades\" role=\"link\" tabindex=\"0\">Armando</a>.</p>",
			},
			'necessidades': {
				'text': "<p>Armando pensa e diz:</p>\n<ul>\n<li>O que eu mais preciso é melhorar o nosso relacionamento com o cliente. Para isso, a informação que vem do sistema de vendas é essencial. Uma coisa importante, por exemplo, é saber que clientes freqüentes não compram mais na freqüência que compravam. </li>\n</ul>\n<p>Você pergunta se eles tem <a class=\"squiffy-link link-passage\" data-passage=\"oportunidade 1\" role=\"link\" tabindex=\"0\">alguma idéia</a>,</p>",
			},
			'oportunidade 1': {
				'text': "<p>Bruna diz:</p>\n<ul>\n<li>Outro é classificar os clientes de acordo com o tipo de livro que gostam, para podermos fazer ofertas de livros novos. No fundo, conhecer os principais clientes é nosso principal segredo.</li>\n</ul>\n<p>Logo depois, Armando parece querer falar. Você pergunta <a class=\"squiffy-link link-passage\" data-passage=\"internet\" role=\"link\" tabindex=\"0\">o que ele pensa</a>?</p>",
			},
			'internet': {
				'text': "<p>Tenho pensado muito em como um sistema pode nos ajudar. Até mesmo pensei se não seria interessante vender livros pela Internet, o que vocês acham disso? Seria uma grande novidade para nós e nossos clientes. Acho que comentei com meu pai, mas ele nunca presta atenção em tecnologia. </p>\n<p>Você concorda e pergunta se há algum <a class=\"squiffy-link link-passage\" data-passage=\"problema\" role=\"link\" tabindex=\"0\">problema</a> que deva estar ciente.</p>",
			},
			'problema': {
				'text': "<p>Bruna diz:</p>\n<p>Hum... não sei se gostei da ideia de vender pela Internet. Mas um site seria ótimo. </p>\n<p>Outra coisa importante é que, com os problemas de entrega, acabamos com um pequeno estoque de livros que compramos, mas os clientes não compraram da gente. Então eu quero fazer algo com isso. Uma mala direta de promoção, por exemplo. Acho que nossos clientes iam gostar de receber pequenos catálogos com livros de qualidade.</p>\n<p>Você pode perguntar:</p>\n<ul>\n<li>Como são feitas as <a class=\"squiffy-link link-passage\" data-passage=\"antigas\" role=\"link\" tabindex=\"0\">coisas aqui</a>?</li>\n</ul>",
			},
		},
	},
	'gerencia 2': {
		'text': "<p>Você pensa um pouco e vê que tem mais perguntas:</p>\n<ul>\n<li>Quantas <a class=\"squiffy-link link-passage\" data-passage=\"pessoas\" role=\"link\" tabindex=\"0\">pessoas</a> trabalham aqui?</li>\n<li>Que <a class=\"squiffy-link link-passage\" data-passage=\"gerencia\" role=\"link\" tabindex=\"0\">informações</a> gerencial vocês precisam?</li>\n</ul>",
		'passageCount': 4,
		'passages': {
			'pessoas': {
				'text': "<p>Bruna diz:</p>\n<p>Hoje somos 7. Todo mundo tem seu cargo, mas todo mundo ajuda todo mundo. A Débora Dina e recepcionista e secretária, o Carlos faz tudo de TI sozinho, os vendedores falam com clientes e fornecedores, e nós também vendemos, fazemos tudo. Papai já está velho, mas tem cliente importantes que compram livros raros caríssimos e também trabalha muito.</p>\n<p>Armando também parece querer falar algo e você pede que ele <a class=\"squiffy-link link-passage\" data-passage=\"mais pessoas\" role=\"link\" tabindex=\"0\">participe</a>.</p>",
			},
			'mais pessoas': {
				'text': "<p>Armando diz:</p>\n<p>Primeiro pensei em contratar mais pessoas, porém isso não ia diminuir a confusão de papéis com que estamos lidando e a falta de informações, então resolvi que seria necessário informatizar a empresa para, se necessário, crescer. </p>\n<p>Bruna olha preocupada.</p>\n<p>Você pode perguntar:</p>\n<ul>\n<li>Que <a class=\"squiffy-link link-passage\" data-passage=\"gerencia\" role=\"link\" tabindex=\"0\">informações</a> gerencial vocês precisam?</li>\n</ul>",
			},
			'gerencia': {
				'text': "<p>Armando diz:</p>\n<p>A partir dessa operação, também são necessários alguns dados para ajudar a gerenciar melhor a empresa. Dois relatórios são muito importantes para nós: um relatório de vendas em um período e um relatório de gastos por fornecedor. Outro relatório que nos ajudaria muito é o de pedidos não atendidos.</p>\n<p>Bruna <a class=\"squiffy-link link-passage\" data-passage=\"interrompe\" role=\"link\" tabindex=\"0\">interrompe</a>.</p>",
			},
			'interrompe': {
				'text': "<p>A gente precisa ter uma agenda de entregas, Tudo que tem que ser entregue e um status dizendo se já foi pedido, já foi recebido, já foi enviado e se já foi pago. Eu faço isso com cadernos, mas são muitos livros agora, acabo tendo que virar de página o tempo todo.</p>\n<p>Você pode perguntar:</p>\n<ul>\n<li>Quantas <a class=\"squiffy-link link-passage\" data-passage=\"pessoas\" role=\"link\" tabindex=\"0\">pessoas</a> trabalham aqui?</li>\n</ul>",
			},
			'@last': {
	...
	'pacientemente': {
		'text': "<h1 id=\"conversando-com-os-vendedores\">Conversando com os vendedores</h1>\n<p>Depois de algum tempo os dois telefonemas acabam praticamente juntos. Parece até que estavam falando um com o outro, mas claramente não foi isso. </p>\n<p>Felipe diz, {if seen interromper: parecendo irritado com você}{else: com um ar simpático}: </p>\n<ul>\n<li>Olá o que deseja?</li>\n</ul>\n<p>Você se apresenta e se explica, diz que está procurando informações para fazer um sistema que vai ajudá-los, pede desculpas por atrapalhar o serviço, mas que precisa da opinião deles.</p>\n<p>Eles ficam muito satisfeitos e começam a falar ao mesmo tempo. Parece que estão ansiosos por alguma ajuda.</p>\n<p>Você:</p>\n<ul>\n<li>Pede para <a class=\"squiffy-link link-passage\" data-passage=\"erros\" role=\"link\" tabindex=\"0\">Felipe</a> falar </li>\n<li>Pede para <a class=\"squiffy-link link-passage\" data-passage=\"arquivos\" role=\"link\" tabindex=\"0\">Gabriela</a> falar</li>\n</ul>",
		'passageCount': 4,
		'passages': {
			'erros': {
				'text': "<p>Felipe fala {if seen interromper:, talvez um pouco irritado}{else: animado}:</p>\n<ul>\n<li>Hoje nosso processo, como é todo manual, tem muitos defeitos. Temos muita informação repetida, pois temos que controlar os pedidos dos clientes e as requisições aos fornecedores, que se cruzam. Muitas vezes recebemos um livro e por um problema de anotação não sabemos para qual cliente se destina. Então gastamos um bom tempo procurando, cliente por cliente, quem pediu aquele livro. </li>\n</ul>\n<p>Ele parece querer falar <a class=\"squiffy-link link-passage\" data-passage=\"demanda\" role=\"link\" tabindex=\"0\">mais</a>{if not seen arquivos:, mas você pode escutar <a class=\"squiffy-link link-passage\" data-passage=\"arquivos\" role=\"link\" tabindex=\"0\">Gabriela</a>}{else: {if not seen reclamacoes:, mas você pode escutar <a class=\"squiffy-link link-passage\" data-passage=\"reclamacoes\" role=\"link\" tabindex=\"0\">Gabriela</a>}}.</p>",
			},
			'demanda': {
				'text': "<p>Felipe aproveita para continuar:</p>\n<ul>\n<li>Claramente, a primeira coisa que o sistema deve fazer é suportar o nosso funcionamento diário. Estou falando da operação básica de atendimento aos clientes, não da cobrança ou outras coisas do gênero, pois para essas vou comprar sistemas prontos .</li>\n</ul>\n<p>Felipe parece ter acabado{if not seen arquivos:, você se vira para <a class=\"squiffy-link link-passage\" data-passage=\"arquivos\" role=\"link\" tabindex=\"0\">Gabriela</a>}{else: {if not seen reclamacoes:, você se vira para <a class=\"squiffy-link link-passage\" data-passage=\"reclamacoes\" role=\"link\" tabindex=\"0\">Gabriela</a>}}.</p>",
			},
			'arquivos': {
				'text': "<p>Gabriela também tem informações {if seen interromper:, ela parece indecisa sobre você, porém fala}{else: e as fornece prontamente}:</p>\n<ul>\n<li>Mantemos também vários arquivos de clientes, o que facilita em certos casos, mas dificulta em outros. Temos os clientes com pedido em andamento, aqueles com pedidos atendidos, mas não pagos, os freqüentes e os outros clientes, que não se enquadram em nenhuma dessas categorias. E tem a lista dos clientes “expulsos”, pois nos deram calote e ainda tem a cara de pau de pedir outro livro.</li>\n</ul>\n<p>Ela parece querer falar <a class=\"squiffy-link link-passage\" data-passage=\"reclamacoes\" role=\"link\" tabindex=\"0\">mais</a>{if not seen erros:, mas você pode escutar <a class=\"squiffy-link link-passage\" data-passage=\"erros\" role=\"link\" tabindex=\"0\">Felipe</a>}{else: {if not seen demanda:, mas você pode escutar <a class=\"squiffy-link link-passage\" data-passage=\"demanda\" role=\"link\" tabindex=\"0\">Felipe</a>}}.</p>",
			},
			'reclamacoes': {
				'text': "<p>Gabriela continua:</p>\n<ul>\n<li>Como estamos sempre manipulando fichas, algumas vezes esquecemos de requisitar a um fornecedor um ou mais livros pedidos pelo cliente. Isso atrasa o atendimento e resulta em reclamações que não são boas para a livraria.</li>\n</ul>\n<p>Gabriela parece ter acabado{if not seen erros:, você se vira para <a class=\"squiffy-link link-passage\" data-passage=\"erros\" role=\"link\" tabindex=\"0\">Felipe</a>}{else: {if not seen demanda:, você se vira para <a class=\"squiffy-link link-passage\" data-passage=\"demanda\" role=\"link\" tabindex=\"0\">Felipe</a>}}.</p>",
			},
			'@last': {
	...
	'como funciona o trabalho': {
		'text': "<p>{if seen interromper:Eles parecem ter esquecido a forma rude como os interrompeu, e ficam animados com seu interesse}{else: Seu interesse os deixa mais animados}:</p>\n<p>Gabriela diz que existe um passo a passo muito bem definido. Mas que Felipe pode começar a explicar.</p>\n<p>Felipe diz:</p>\n<ul>\n<li><p>Somos nós que fazemos as vendas mesmo aqui, mas às vezes precisamos de ajuda. </p>\n</li>\n<li><p>Normalmente eu recebo um pedido do cliente com uma lista de livros. </p>\n</li>\n<li><p>Então eu vou nos vários catálogos que possuímos, alguns de editoras, outros de distribuidoras, e procuro os livros desejados. Também procuro na internet, em lojas e leilões.</p>\n</li>\n</ul>\n<p>Felipe <a class=\"squiffy-link link-passage\" data-passage=\"respira\" role=\"link\" tabindex=\"0\">respira</a> e Gabriela olha com sinal de aprovação.</p>",
		'passageCount': 4,
		'passages': {
			'respira': {
				'text': "<p>Felipe continua:</p>\n<ul>\n<li><p>Faço uma lista com cada livro, onde podemos comprá-los, o prazo de entrega, e o preço de custo e uma estimativa de preço de frete. </p>\n</li>\n<li><p>Algumas vezes tenho que esperar uma cotação que vai chegar for e-mail ou telefone, então eu paro o serviço para começar mais tarde.</p>\n</li>\n<li><p>Essa lista eu envio para a Bruna, que define o preço de venda de cada livro. Ela faz isso baseada na experiência dela com os clientes e as necessidades da empresa. </p>\n</li>\n<li><p>Nós compramos os livros em muitas moedas, são livros caros, de arte, ou livros raros e antigos, de colecionador, e a taxa de câmbio também é importante.</p>\n</li>\n</ul>\n<p>Felipe para, fica pensando e Gabriela <a class=\"squiffy-link link-passage\" data-passage=\"passa a falar\" role=\"link\" tabindex=\"0\">passa a falar</a>:</p>",
			},
			'passa a falar': {
				'text': "<ul>\n<li><p>Com os preços definidos eu faço uma estimativa do frete para o cliente e preparo uma proposta. Essa proposta é passada para o cliente de várias formas: telefone, e-mail ou, ultimamente, Whatsapp. </p>\n</li>\n<li><p>Geralmente dentro de 24h o cliente confirma a proposta, ou parte dela. Eu então separo os pedidos que serão feitos na sexta-feira. </p>\n</li>\n<li><p>Quem trata dessa parte dos pedidos para os fornecedores é o próprio Sr. Américo ou seu filho. Muitas vezes ele consegue mais um desconto na compra dos livros. Algumas das vezes esse desconto, ou parte dele, é repassado para o cliente.</p>\n</li>\n</ul>\n<p>Gabriela pega um copo de água em sua mesa e <a class=\"squiffy-link link-passage\" data-passage=\"bebeu\" role=\"link\" tabindex=\"0\">bebe</a> um pouco, pegando fôlego.</p>",
			},
			'bebeu': {
				'text': "<p>Gabriela continua:</p>\n<ul>\n<li><p>Quando chegam todos os livros de um cliente eu começo a trabalhar de novo. </p>\n</li>\n<li><p>Sou eu quem “fecha” a venda. Recalculo o preço de custo e de venda. Passo os casos de possível desconto para a Bruna, que decide na hora. Emito uma fatura, uma nota fiscal, empacoto e preparo para os entregadores (a gente usa a DHL ou a Fedex). Muitas vezes eu telefono, ou mando um e-mail, para avisar o cliente que o pedido está sendo enviado. </p>\n</li>\n</ul>\n<p>Você pergunta:</p>\n<ul>\n<li>Como os clientes <a class=\"squiffy-link link-passage\" data-passage=\"pagam\" role=\"link\" tabindex=\"0\">pagam</a>?</li>\n</ul>",
			},
			'pagam': {
				'text': "<p>Gabriela não parece gostar desse assunto:</p>\n<ul>\n<li>Hoje pelo boleto. É muito ruim, porque demora uns 3 dias para sabermos que foi pago, e o cliente às vezes esquece de pagar e pede uma segunda via, ou ainda temos que lembrá-los disso, o que é sempre desagradável.</li>\n</ul>\n<p>Felipe diz:</p>\n<ul>\n<li>A gente também pensou em usar cartão de crédito ou débito, mas não gostamos das taxas. Teríamos que somá-la ao nosso preço e os clientes também não vão gostar. </li>\n</ul>\n<p>Gabriela revira os olhos, como se essa discussão fosse antiga:</p>\n<ul>\n<li>Os clientes nem iam saber, a gente podia cobrar a taxa de todo mundo e não ia fazer diferença, mas claramente o Sr. Arnaldo não quer fazer isso.</li>\n</ul>",
			},
			'@last': {
