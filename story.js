...
squiffy.story.sections = {
	...
	'pergunta': {
		...
		'passages': {
			...
			'atendimento': {
				'text': "<p>O Sr. Arnaldo explica:</p>\n<ul>\n<li>Os pedidos dos clientes são atendidos imediatamente quando completos, isto é, quando todos os livros pedidos foram enviados pelos fornecedores (ou forem cancelados). O atendimento, que é a entrega pelo correio, consiste na emissão de um boleto de pagamento, que é pago, e depois de uma nota fiscal, que é enviada então com o livro. Cópias da nota fiscal e do boleto são enviadas ao contador, que é terceirizado. </li>\n</ul>\n<p>Você então pergunta:</p>\n<ul>\n<li><a class=\"squiffy-link link-passage\" data-passage=\"cancelado\" role=\"link\" tabindex=\"0\">Como</a> um livro pode ser cancelado?</li>\n</ul>",
				'attributes': ["começou"],
			},
			'cancelado': {
